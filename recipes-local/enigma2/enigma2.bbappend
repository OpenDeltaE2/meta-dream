...
ENIGMA2_BRANCH:dm800se = "master"
ENIGMA2_BRANCH:dm800sev2 = "master"

ENIGMA2_BRANCH ?= "master"
GITHUB_URI ?= "git://github.com"
SRC_URI = "${GITHUB_URI}/OpenDeltaE2/enigma2-r21.git;protocol=https;branch=${ENIGMA2_BRANCH} \
...
ENIGMA2_BRANCH ?= "master"
GITHUB_URI ?= "git://github.com"
SRC_URI:dm800sev2 = "${GITHUB_URI}/OpenDeltaE2/enigma2-r21.git;protocol=https;branch=${ENIGMA2_BRANCH} \
	file://001-use-mallinfo2.patch \
	file://002-fix-build-gcc11.patch \
	file://003-get-rid-of-register-keyword.patch \
	file://004-suppress-compile-errors.patch \
